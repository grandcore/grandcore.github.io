...
- <span style="vertical-align: -12px">![trello-dev](../../_media/icon-trello.png ":size=32")</span> [**Обсуждение Архитектуры**](https://trello.com/b/POeLUekC/openschool-dev)
...
Платформа наполняется сообществом. Курсы не являются авторскими, любой может предложить изменения, которые сообщество принимает голосованием (см. [EDem](ru/edem.md), систему коллективного управления проектами). Работоспособность платформы поддерживается донатами и грантами. Волонтёры могут открывать сбор средств для оплаты своего труда по созданию и доработке курсов.
